...
import { W8_state_ECI, postW8ECI_EForm } from "../../../Redux/Actions";
...
const Declaration = (props: any) => {
  ...
  const initialValue = {
    isAgreeWithDeclaration: W8ECIData.isAgreeWithDeclaration ?? false,
    isConsentRecipent: W8ECIData.isConsentRecipent ?? false,
