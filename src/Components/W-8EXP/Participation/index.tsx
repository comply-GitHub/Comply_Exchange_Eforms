...
import { partCertiSchema,partCertiSchema_W8Exp } from "../../../schemas/w8Exp";
...
const RetroactiveStatementValue = localStorage.getItem("RetroactiveStatement");
  ...
  const [initialValue, setInitialValues] = useState({
    ...
    ,
    isAcceptanceDeclarations: W8EXPData?.isAcceptanceDeclarations ?? false,
  ...
  return (
    <>
      <Formik
        ...
        validationSchema={RetroactiveStatementValue == "true" ? partCertiSchema_W8Exp(RetroactiveStatementValue) : partCertiSchema}
