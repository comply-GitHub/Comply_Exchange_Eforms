...
export default function Fedral_tax(props: any) {
  ...
  const W8BENEData = useSelector((state: any) => (state?.W8BENE?.chapter4Status !== 0) ? state?.W8BENE : JSON.parse(localStorage.getItem("PrevStepData") || "{}"));
                    ...
                    const returnPromise = new Promise((resolve, reject) => {
                      dispatch(postW8BEN_EForm(
                        ...
                        (responseData: any) => {
                          ...
                          if (values.isPassiveNFFE40C == true && values.isPassiveNFFE40B == false) {
                            dispatch(
                              UpsertSubstantialUsPassiveNFE(
                                () => {
                            ...
                            <div className="row d-flex">
                              ...
                              >
                                ...
                                <FormControl className="w-50">
                                  <select
                                    name="chapter4Status"
                                    value={values.chapter4Status}
                                    onChange={handleChange}
                                    autoComplete="chapter4Status"
                                    onBlur={handleBlur}
                                    style={{
                                      padding: " 0 10px",
                                      color: "#121112",
                                  ...
                                  <p className="error">
                                    {errors.chapter4Status}
                                  </p>
                                </FormControl>
                              </div>

                            </div>
                            {values.chapter4Status == 2 || values.chapter4Status == 27
                              ? (
                                <>
                                  <div>
                                  ...
                                  <div className="d-flex mt-3">
                                    ...
                                    <Typography>
                                      <Checkbox name="isPassiveNFFE40A" checked={values.isPassiveNFFE40A} value={values.isPassiveNFFE40A}
                                        onChange={handleChange} />
                                    </Typography>
                                  ...
                                  <div className="d-flex mt-3">
                                    ...
                                    <Typography>
                                      <Checkbox name="isPassiveNFFE40B" checked={values.isPassiveNFFE40B} value={values.isPassiveNFFE40B}
                                        onChange={(e) => { handleChange(e); setTimeout(() => { setFieldValue("isPassiveNFFE40C", false) }, 100) }} />
                                    </Typography>
                                    <Typography className="mt-2">
                                  ...
                                  <div className="d-flex mt-3">
                                    ...
                                    <Typography>
                                      <Checkbox name="isPassiveNFFE40C" checked={values.isPassiveNFFE40C} value={values.isPassiveNFFE40C}
                                        onChange={(e) => { handleChange(e); setTimeout(() => { setFieldValue("isPassiveNFFE40B", false) }, 100) }} />
                                    </Typography>
                                    <Typography className="mt-2">
                                      I certify that the entity identified in Part I
                                    </Typography>
                                  ...
                                  {values.isPassiveNFFE40C ? (<SubstantialUsPassiveNFE formTypeId={3} submitPassiveNFEData={submitPassiveNFEData} />) : ""}
                                </>) : ""}


                            {values.chapter4Status == 6 ? (
                              <>
                                <Typography style={{ border: "2px solid black", color: "white", backgroundColor: "black" }}>
