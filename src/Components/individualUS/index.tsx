          ...
          >
            <Formik
              ...
              onSubmit={(values, { setSubmitting }) => {
                ...
                dispatch(postOnboarding(payload, (data: any) => {
                  ...
                  localStorage.setItem("Form", "individual");
            ...
            >
              {({
                ...
                console.log('Selected isCorrectPaymentPurposes2 ID:', values.isCorrectPaymentPurposes2);
                console.log('Selected isCorrectPaymentPurposes2 ID:', typeof values.isCorrectPaymentPurposes2);
                                ...
                                <FormControl error={Boolean(errors.isUSIndividual)}>
                                  <RadioGroup
                                    ...
                                    onChange={(e) => {
                                      ...
                                      //   window.history.pushState({}, "", "/IndividualUs")
                                      // } else {
                                      //   window.history.pushState({}, "", "/IndividualNonUS")
                                      // }
