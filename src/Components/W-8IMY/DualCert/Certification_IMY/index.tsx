                ...
                {({
                  ...
                  <Form onSubmit={handleSubmit}>
                    <Paper style={{ padding: "14px" }}>
                      ...
                      >
                        I/We declare (as an authorised signatory of the Entity) that the information provided in this form is, to the best of my knowledge and belief, accurate and complete. I/We undertake to advise the recipient promptly and <strong>provide an updated Self-Certification form within 30 days where any change in circumstances occurs </strong>  which causes any of the information contained in this form to be Inaccurate or incomplete. Where legally obliged to do so, I/We hereby consent to the recipient sharing this information with the relevant tax information authorities.
                      </Typography>
                      <Typography style={{
                        margin: "10px",
                        fontSize: "14px",
