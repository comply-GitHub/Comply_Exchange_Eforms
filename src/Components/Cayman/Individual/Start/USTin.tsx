...
import { GetHelpVideoDetails, postSCIndividualEForm, getAllCountries, getAllCountriesCode, getAllCountriesIncomeCode, getAllStateByCountryId, getTinTypes } from "../../../../Redux/Actions";
        ...
        <label>If you are not a resident in any other countries than the countries stated above, check this box</label>
                    ...
                    {/* {values.itemList?.map((item:any,index:number) => {
                        ...
                        <Typography>
                            ...
                            <Typography>
                                {item.permanentResidentialCountryId}
                            </Typography>
                        </>
