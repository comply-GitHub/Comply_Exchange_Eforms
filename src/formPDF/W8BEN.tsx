      ...
      >
        ...
        >
          ...
          <View wrap={false}>
            ...
            >
              <div style={{ margin: "10px auto" }}>
                <div className="page page1" style={{ height: "auto", width: "100%", color: "black", fontFamily: "sans-serif", padding: "60px 30px 30px", boxSizing: "border-box", marginBottom: "4px" }}>
                  <table
                    style={{
                      width: "100%",
                      maxWidth: "920px",
                ...
                <div className="page page3" style={{ height: "29cm", width: "100%", color: "black", fontFamily: "sans-serif", padding: "60px 30px 30px", boxSizing: "border-box", marginBottom: "4px" }}>
                  <table
                    style={{
                      borderCollapse: "collapse",
                      width: "100%",
                ...
                <div className="page page4" style={{ height: "29cm", width: "100%", color: "black", fontFamily: "sans-serif", padding: "60px 30px 30px", boxSizing: "border-box", marginBottom: "4px" }}>
                  <table
                    style={{
                      borderCollapse: "collapse",
                      width: "100%",
                ...
                <div className="page page5" style={{ height: "29cm", width: "100%", color: "black", fontFamily: "sans-serif", padding: "60px 30px 30px", boxSizing: "border-box", marginBottom: "4px" }}>
                  <table
                    style={{
                      borderCollapse: "collapse",
                      borderSpacing: "0",
          ...
          <div style={{ paddingTop: "20px", textAlign: "center" }}>
            ...
            <Button onClick={backFunction} variant="contained" style={{
              border: "1px solid #0095dd",
              background: "#0095dd",
              height: "45px",
              lineHeight: "normal",
